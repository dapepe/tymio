...
class KickstartValidator {
	...
	private $callbacks = array(
		FILTER_VALIDATE_MIN_LENGTH     => array('KickstartValidator', 'filter_min_length'),
		FILTER_VALIDATE_MAX_LENGTH     => array('KickstartValidator', 'filter_max_length'),
		FILTER_VALIDATE_LENGTH         => array('KickstartValidator', 'filter_length'),
		FILTER_VALIDATE_DATE_RANGE     => array('KickstartValidator', 'filter_date_range'),
		FILTER_VALIDATE_DATE_START_END => array('KickstartValidator', 'filter_date_start_end'),
		FILTER_VALIDATE_INTZERO        => array('KickstartValidator', 'filter_int_zero'),
	);
	...
	/**
	 * Returns a KickstartValidator object
	 *
	 * @return KickstartValidator
	 */
