...
abstract class BaseTransactionPeer
{
    ...
    const CREATOR_ID = 'transaction.creator_id';
    ...
    const CREATIONDATE = 'transaction.creationdate';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'CreatorId', 'UserId', 'Deleted', 'Start', 'End', 'Creationdate', 'Comment', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'creatorId', 'userId', 'deleted', 'start', 'end', 'creationdate', 'comment', ),
        BasePeer::TYPE_COLNAME => array (TransactionPeer::ID, TransactionPeer::CREATOR_ID, TransactionPeer::USER_ID, TransactionPeer::DELETED, TransactionPeer::START, TransactionPeer::END, TransactionPeer::CREATIONDATE, TransactionPeer::COMMENT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CREATOR_ID', 'USER_ID', 'DELETED', 'START', 'END', 'CREATIONDATE', 'COMMENT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'creator_id', 'user_id', 'deleted', 'start', 'end', 'creationdate', 'comment', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CreatorId' => 1, 'UserId' => 2, 'Deleted' => 3, 'Start' => 4, 'End' => 5, 'Creationdate' => 6, 'Comment' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'creatorId' => 1, 'userId' => 2, 'deleted' => 3, 'start' => 4, 'end' => 5, 'creationdate' => 6, 'comment' => 7, ),
        BasePeer::TYPE_COLNAME => array (TransactionPeer::ID => 0, TransactionPeer::CREATOR_ID => 1, TransactionPeer::USER_ID => 2, TransactionPeer::DELETED => 3, TransactionPeer::START => 4, TransactionPeer::END => 5, TransactionPeer::CREATIONDATE => 6, TransactionPeer::COMMENT => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CREATOR_ID' => 1, 'USER_ID' => 2, 'DELETED' => 3, 'START' => 4, 'END' => 5, 'CREATIONDATE' => 6, 'COMMENT' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'creator_id' => 1, 'user_id' => 2, 'deleted' => 3, 'start' => 4, 'end' => 5, 'creationdate' => 6, 'comment' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TransactionPeer::CREATOR_ID);
            $criteria->addSelectColumn(TransactionPeer::USER_ID);
            $criteria->addSelectColumn(TransactionPeer::DELETED);
            $criteria->addSelectColumn(TransactionPeer::START);
            $criteria->addSelectColumn(TransactionPeer::END);
            $criteria->addSelectColumn(TransactionPeer::CREATIONDATE);
            $criteria->addSelectColumn(TransactionPeer::COMMENT);
        } else {
    ...
    public static function doCountJoinUserRelatedByCreatorId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TransactionPeer::CREATOR_ID, UserPeer::ID, $join_behavior);
    ...
    public static function doSelectJoinUserRelatedByCreatorId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                $obj2->addTransactionRelatedByCreatorId($obj1);
    ...
    public static function doSelectJoinUserRelatedByUserId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Transaction) to $obj2 (User)
                $obj2->addTransactionRelatedByUserId($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Transaction) to the collection in $obj3 (User)
                $obj3->addTransactionRelatedByUserId($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Transaction objects pre-filled with all related objects except UserRelatedByCreatorId.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Transaction objects pre-filled with all related objects except UserRelatedByUserId.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(BookingPeer::TRANSACTION_ID, $obj->getId());
            ...
            $criteria->add(TransactionClockingPeer::TRANSACTION_ID, $obj->getId());
