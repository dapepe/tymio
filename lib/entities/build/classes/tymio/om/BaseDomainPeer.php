...
abstract class BaseDomainPeer
{
    ...
    const ACCOUNT_ID = 'domain.account_id';

    /** the column name for the address_id field */
    const ADDRESS_ID = 'domain.address_id';

    /** the column name for the name field */
    const NAME = 'domain.name';

    /** the column name for the valid field */
    const VALID = 'domain.valid';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'AccountId', 'AddressId', 'Name', 'Valid', 'Description', 'Number', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'accountId', 'addressId', 'name', 'valid', 'description', 'number', ),
        BasePeer::TYPE_COLNAME => array (DomainPeer::ID, DomainPeer::ACCOUNT_ID, DomainPeer::ADDRESS_ID, DomainPeer::NAME, DomainPeer::VALID, DomainPeer::DESCRIPTION, DomainPeer::NUMBER, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ACCOUNT_ID', 'ADDRESS_ID', 'NAME', 'VALID', 'DESCRIPTION', 'NUMBER', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'account_id', 'address_id', 'name', 'valid', 'description', 'number', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AccountId' => 1, 'AddressId' => 2, 'Name' => 3, 'Valid' => 4, 'Description' => 5, 'Number' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'accountId' => 1, 'addressId' => 2, 'name' => 3, 'valid' => 4, 'description' => 5, 'number' => 6, ),
        BasePeer::TYPE_COLNAME => array (DomainPeer::ID => 0, DomainPeer::ACCOUNT_ID => 1, DomainPeer::ADDRESS_ID => 2, DomainPeer::NAME => 3, DomainPeer::VALID => 4, DomainPeer::DESCRIPTION => 5, DomainPeer::NUMBER => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ACCOUNT_ID' => 1, 'ADDRESS_ID' => 2, 'NAME' => 3, 'VALID' => 4, 'DESCRIPTION' => 5, 'NUMBER' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'account_id' => 1, 'address_id' => 2, 'name' => 3, 'valid' => 4, 'description' => 5, 'number' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(DomainPeer::ACCOUNT_ID);
            $criteria->addSelectColumn(DomainPeer::ADDRESS_ID);
            $criteria->addSelectColumn(DomainPeer::NAME);
            $criteria->addSelectColumn(DomainPeer::VALID);
            $criteria->addSelectColumn(DomainPeer::DESCRIPTION);
            $criteria->addSelectColumn(DomainPeer::NUMBER);
        } else {
    ...
    public static function doCountJoinAccount(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(DomainPeer::ACCOUNT_ID, AccountPeer::ID, $join_behavior);
    ...
    public static function doCountJoinAddress(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(DomainPeer::ADDRESS_ID, AddressPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Domain objects pre-filled with their Account objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAccount(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Domain) to $obj2 (Account)
                $obj2->addDomain($obj1);
    ...
    /**
     * Selects a collection of Domain objects pre-filled with their Address objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Domain objects.
    ...
    public static function doSelectJoinAddress(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Domain) to $obj2 (Address)
                $obj2->addDomain($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Domain) to the collection in $obj2 (Account)
                $obj2->addDomain($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Domain) to the collection in $obj3 (Address)
                $obj3->addDomain($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Domain objects pre-filled with all related objects except Account.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptAccount(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = DomainPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Domain) to the collection in $obj2 (Address)
                $obj2->addDomain($obj1);
    ...
    /**
     * Selects a collection of Domain objects pre-filled with all related objects except Address.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
