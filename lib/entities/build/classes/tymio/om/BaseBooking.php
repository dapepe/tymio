...
abstract class BaseBooking extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the booking_type_id field.
     * @var        int
     */
    protected $booking_type_id;
    ...
    /**
     * Get the [booking_type_id] column value.
     *
     * @return int
     */
    ...
    public function setTransactionId($v)
    {
        ...
        if ($this->transaction_id !== $v) {
            ...
            $this->modifiedColumns[] = BookingPeer::TRANSACTION_ID;
        }
    ...
    /**
     * Set the value of [booking_type_id] column.
     *
     * @param int $v new value
     * @return Booking The current object (for fluent API support)
     */
    public function setBookingTypeId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->booking_type_id !== $v) {
            $this->booking_type_id = $v;
            $this->modifiedColumns[] = BookingPeer::BOOKING_TYPE_ID;
        }

        if ($this->aBookingType !== null && $this->aBookingType->getId() !== $v) {
    ...
    public function setLabel($v)
    {
        ...
        if ($this->label !== $v) {
            $this->label = $v;
            $this->modifiedColumns[] = BookingPeer::LABEL;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[] = BookingPeer::VALUE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->transaction_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->booking_type_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 5; // 5 = BookingPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aBookingType !== null && $this->booking_type_id !== $this->aBookingType->getId()) {
            $this->aBookingType = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aBookingType !== null) {
                if ($this->aBookingType->isModified() || $this->aBookingType->isNew()) {
                    $affectedRows += $this->aBookingType->save($con);
                }
                $this->setBookingType($this->aBookingType);
            }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aBookingType !== null) {
                if (!$this->aBookingType->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aBookingType->getValidationFailures());
                }
            }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setTransactionId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setBookingTypeId($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BookingPeer::TRANSACTION_ID)) $criteria->add(BookingPeer::TRANSACTION_ID, $this->transaction_id);
        if ($this->isColumnModified(BookingPeer::BOOKING_TYPE_ID)) $criteria->add(BookingPeer::BOOKING_TYPE_ID, $this->booking_type_id);
        if ($this->isColumnModified(BookingPeer::LABEL)) $criteria->add(BookingPeer::LABEL, $this->label);
        if ($this->isColumnModified(BookingPeer::VALUE)) $criteria->add(BookingPeer::VALUE, $this->value);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setBookingTypeId($this->getBookingTypeId());
    ...
    public function getTransaction(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aTransaction === null && ($this->transaction_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTransaction->addBookings($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a BookingType object.
     *
     * @param             BookingType $v
     * @return Booking The current object (for fluent API support)
     * @throws PropelException
     */
    public function setBookingType(BookingType $v = null)
    {
        if ($v === null) {
            $this->setBookingTypeId(NULL);
        } else {
            $this->setBookingTypeId($v->getId());
        }

        $this->aBookingType = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the BookingType object, it will not be re-added.
        if ($v !== null) {
            $v->addBooking($this);
        }
