 ...
 * @method BookingQuery orderByTransactionId($order = Criteria::ASC) Order by the transaction_id column
 * @method BookingQuery orderByBookingTypeId($order = Criteria::ASC) Order by the booking_type_id column
 * @method BookingQuery orderByLabel($order = Criteria::ASC) Order by the label column
 * @method BookingQuery orderByValue($order = Criteria::ASC) Order by the value column
 *
 * @method BookingQuery groupById() Group by the id column
 * @method BookingQuery groupByTransactionId() Group by the transaction_id column
 * @method BookingQuery groupByBookingTypeId() Group by the booking_type_id column
 * @method BookingQuery groupByLabel() Group by the label column
 * @method BookingQuery groupByValue() Group by the value column
 *
 ...
 *
 * @method BookingQuery leftJoinTransaction($relationAlias = null) Adds a LEFT JOIN clause to the query using the Transaction relation
 * @method BookingQuery rightJoinTransaction($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Transaction relation
 * @method BookingQuery innerJoinTransaction($relationAlias = null) Adds a INNER JOIN clause to the query using the Transaction relation
 *
 * @method BookingQuery leftJoinBookingType($relationAlias = null) Adds a LEFT JOIN clause to the query using the BookingType relation
 * @method BookingQuery rightJoinBookingType($relationAlias = null) Adds a RIGHT JOIN clause to the query using the BookingType relation
 * @method BookingQuery innerJoinBookingType($relationAlias = null) Adds a INNER JOIN clause to the query using the BookingType relation
 *
 ...
 *
 * @method Booking findOneByTransactionId(int $transaction_id) Return the first Booking filtered by the transaction_id column
 * @method Booking findOneByBookingTypeId(int $booking_type_id) Return the first Booking filtered by the booking_type_id column
 * @method Booking findOneByLabel(string $label) Return the first Booking filtered by the label column
 * @method Booking findOneByValue(int $value) Return the first Booking filtered by the value column
 *
 * @method array findById(int $id) Return Booking objects filtered by the id column
 * @method array findByTransactionId(int $transaction_id) Return Booking objects filtered by the transaction_id column
 * @method array findByBookingTypeId(int $booking_type_id) Return Booking objects filtered by the booking_type_id column
 * @method array findByLabel(string $label) Return Booking objects filtered by the label column
 * @method array findByValue(int $value) Return Booking objects filtered by the value column
 *
...
abstract class BaseBookingQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'tymio', $modelName = 'Booking', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `transaction_id`, `booking_type_id`, `label`, `value` FROM `booking` WHERE `id` = :p0';
        try {
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(BookingPeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(BookingPeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByTransactionId($transactionId = null, $comparison = null)
    {
        if (is_array($transactionId)) {
            ...
            if (isset($transactionId['min'])) {
                $this->addUsingAlias(BookingPeer::TRANSACTION_ID, $transactionId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($transactionId['max'])) {
                $this->addUsingAlias(BookingPeer::TRANSACTION_ID, $transactionId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BookingPeer::TRANSACTION_ID, $transactionId, $comparison);
    }

    /**
     * Filter the query on the booking_type_id column
     *
     * Example usage:
     * <code>
     * $query->filterByBookingTypeId(1234); // WHERE booking_type_id = 1234
     * $query->filterByBookingTypeId(array(12, 34)); // WHERE booking_type_id IN (12, 34)
     * $query->filterByBookingTypeId(array('min' => 12)); // WHERE booking_type_id >= 12
     * $query->filterByBookingTypeId(array('max' => 12)); // WHERE booking_type_id <= 12
     * </code>
     *
     * @see       filterByBookingType()
     *
     * @param     mixed $bookingTypeId The value to use as filter.
     *              Use scalar values for equality.
     *              Use array values for in_array() equivalent.
     *              Use associative array('min' => $minValue, 'max' => $maxValue) for intervals.
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     ...
     * @return BookingQuery The current query, for fluid interface
     */
    public function filterByBookingTypeId($bookingTypeId = null, $comparison = null)
    {
        if (is_array($bookingTypeId)) {
            $useMinMax = false;
            if (isset($bookingTypeId['min'])) {
                $this->addUsingAlias(BookingPeer::BOOKING_TYPE_ID, $bookingTypeId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($bookingTypeId['max'])) {
                $this->addUsingAlias(BookingPeer::BOOKING_TYPE_ID, $bookingTypeId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BookingPeer::BOOKING_TYPE_ID, $bookingTypeId, $comparison);
    }
    ...
    public function filterByLabel($label = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(BookingPeer::LABEL, $label, $comparison);
    }
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        if (is_array($value)) {
            $useMinMax = false;
            if (isset($value['min'])) {
                $this->addUsingAlias(BookingPeer::VALUE, $value['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($value['max'])) {
                $this->addUsingAlias(BookingPeer::VALUE, $value['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(BookingPeer::VALUE, $value, $comparison);
    }
    ...
    public function filterByTransaction($transaction, $comparison = null)
    {
        if ($transaction instanceof Transaction) {
            return $this
                ->addUsingAlias(BookingPeer::TRANSACTION_ID, $transaction->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(BookingPeer::TRANSACTION_ID, $transaction->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByBookingType($bookingType, $comparison = null)
    {
        if ($bookingType instanceof BookingType) {
            return $this
                ->addUsingAlias(BookingPeer::BOOKING_TYPE_ID, $bookingType->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(BookingPeer::BOOKING_TYPE_ID, $bookingType->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
