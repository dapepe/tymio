...
abstract class BaseSystemLog extends BaseObject implements Persistent
{
    ...
    public function setIndex($v)
    {
        ...
        if ($this->index !== $v) {
            $this->index = $v;
            $this->modifiedColumns[] = SystemLogPeer::INDEX;
        }
    ...
    public function setEntity($v)
    {
        ...
        if ($this->entity !== $v) {
            $this->entity = $v;
            $this->modifiedColumns[] = SystemLogPeer::ENTITY;
        }
    ...
    public function setService($v)
    {
        ...
        if ($this->service !== $v) {
            $this->service = $v;
            $this->modifiedColumns[] = SystemLogPeer::SERVICE;
        }
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== $v) {
            $this->data = $v;
            $this->modifiedColumns[] = SystemLogPeer::DATA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->index = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->entity = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->service = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->code = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            ...
            return $startcol + 8; // 8 = SystemLogPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SystemLogPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(SystemLogPeer::INDEX)) {
            $modifiedColumns[':p' . $index++]  = '`index`';
        }
        if ($this->isColumnModified(SystemLogPeer::ENTITY)) {
            $modifiedColumns[':p' . $index++]  = '`entity`';
        }
        if ($this->isColumnModified(SystemLogPeer::SERVICE)) {
        ...
        if ($this->isColumnModified(SystemLogPeer::DATA)) {
            $modifiedColumns[':p' . $index++]  = '`data`';
        }

        $sql = sprintf(
            'INSERT INTO `system_log` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`user_id`':
                        ...
                        break;
                    case '`index`':
                        $stmt->bindValue($identifier, $this->index, PDO::PARAM_STR);
                        break;
                    case '`entity`':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SystemLogPeer::INDEX)) $criteria->add(SystemLogPeer::INDEX, $this->index);
        if ($this->isColumnModified(SystemLogPeer::ENTITY)) $criteria->add(SystemLogPeer::ENTITY, $this->entity);
        if ($this->isColumnModified(SystemLogPeer::SERVICE)) $criteria->add(SystemLogPeer::SERVICE, $this->service);
        ...
        if ($this->isColumnModified(SystemLogPeer::DATA)) $criteria->add(SystemLogPeer::DATA, $this->data);
