...
abstract class BaseHoliday extends BaseObject implements Persistent
{
    ...
    public function setAccountId($v)
    {
        ...
        if ($this->account_id !== $v) {
            $this->account_id = $v;
            $this->modifiedColumns[] = HolidayPeer::ACCOUNT_ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = HolidayPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = HolidayPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(HolidayPeer::ACCOUNT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`account_id`';
        }
        if ($this->isColumnModified(HolidayPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(HolidayPeer::DATE)) {
            $modifiedColumns[':p' . $index++]  = '`date`';
        }

        $sql = sprintf(
            'INSERT INTO `holiday` (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(HolidayPeer::ACCOUNT_ID)) $criteria->add(HolidayPeer::ACCOUNT_ID, $this->account_id);
        if ($this->isColumnModified(HolidayPeer::NAME)) $criteria->add(HolidayPeer::NAME, $this->name);
        if ($this->isColumnModified(HolidayPeer::DATE)) $criteria->add(HolidayPeer::DATE, $this->date);
    ...
    public function getAccount(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAccount === null && ($this->account_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAccount->addHolidays($this);
             */
        }
     ...
     * If this Holiday is new, it will return
    ...
    public function setHolidayDomains(PropelCollection $holidayDomains, PropelPDO $con = null)
    {
        ...
        foreach ($holidayDomainsToDelete as $holidayDomainRemoved) {
            $holidayDomainRemoved->setHoliday(null);
        }
     ...
     * Otherwise if this Holiday is new, it will return
     * an empty collection; or if this Holiday has previously
     * been saved, it will retrieve related HolidayDomains from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Holiday.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|HolidayDomain[] List of HolidayDomain objects
     */
    public function getHolidayDomainsJoinDomain($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = HolidayDomainQuery::create(null, $criteria);
