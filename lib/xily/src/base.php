...
class Base {
	...
	public static function strStripQuotes($strQuote) {
		return Xily\Base::strStripString(Xily\Base::strStripString($strQuote, "'"), '"');
	}
	...
	public static function fileCopyDir($strDirectory, $strDestination, $bolCreate=true) {
		...
		$bolResult = true;
		// Remove the "/" at the end of the directory, if existent
		$strDirectory = Xily\Base::fileFormatdir($strDirectory);
		$strDestination = Xily\Base::fileFormatdir($strDestination);
	 ...
	 */
	public function probe($strSource, $strMessage, $intLevel=0, $mxtVar=null) {
