...
// Load this file's selection again by visiting: http://mootools.net/more/75701e288d2730ec05c13ccf3db9291c 
// Or build this file again with packager using: packager build More/Chain.Wait More/Array.Extras More/Date.Extras More/Number.Format More/URI More/Hash More/Hash.Extras More/Element.Forms More/Elements.From More/Element.Pin More/Form.Request More/Form.Validator More/OverText More/Fx.Elements More/Fx.Accordion More/Fx.Move More/Fx.Reveal More/Fx.Scroll More/Fx.Slide More/Fx.SmoothScroll More/Fx.Sort More/Drag More/Drag.Move More/Slider More/Sortables More/Request.JSONP More/Request.Queue More/Request.Periodical More/Color More/Group More/Hash.Cookie More/Table More/HtmlTable More/HtmlTable.Zebra More/HtmlTable.Sort More/HtmlTable.Select More/Keyboard.Extras More/Scroller More/Tips More/Spinner More/Locale More/Locale.Set.From
/*
---
copyrights:
...
if(a!="tr"){b=new Element("tr").inject(b);}}}return(b||new Element("div")).set("html",e).getChildren();};(function(){var a=false,b=false;var c=function(){var d=new Element("div").setStyles({position:"fixed",top:0,right:0}).inject(document.body);
