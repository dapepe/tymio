...
// Load this file's selection again by visiting: http://mootools.net/more/155ac5d85cb0b02a3f0a24b553dd2787 
// Or build this file again with packager using: packager build More/Events.Pseudos More/Class.Refactor More/Class.Binds More/Class.Occlude More/Chain.Wait More/Array.Extras More/Date.Extras More/Number.Format More/String.Extras More/URI More/URI.Relative More/Hash.Extras More/Element.Event.Pseudos More/Element.Event.Pseudos.Keys More/Element.Measure More/Element.Pin More/Element.Position More/Element.Shortcuts More/Form.Request More/OverText More/Fx.Elements More/Fx.Accordion More/Fx.Move More/Fx.Reveal More/Fx.Scroll More/Fx.Slide More/Fx.SmoothScroll More/Fx.Sort More/Drag More/Drag.Move More/Slider More/Sortables More/Assets More/Color More/Group More/Table More/Keyboard More/Keyboard.Extras More/Scroller More/Tips
/*
---
copyrights:
...
},cleanValues:function(a){return new Hash(Object.cleanValues(this,a));},run:function(){Object.run(arguments);}});(function(){var d={relay:false},c=["once","throttle","pause"],b=c.length;
...
if(!f){d.call(b,g,h,c);f=a;c=new Array(a);}});});}});})();(function(){var a=this.Table=function(){this.length=0;var c=[],b=[];this.set=function(e,g){var d=c.indexOf(e);
